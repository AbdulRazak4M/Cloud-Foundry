		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Project with Destination",
									"targetURL": "#comdestinationproject2dest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdestinationproject2dest-display": {
								"semanticObject": "comdestinationproject2dest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.destination.project2dest",
									"url": sap.ui.require.toUrl("com/destination/project2dest")
								}
							}
						}
					}
